...
namespace NEMultiEdgeSettings
{
    ...
    constexpr std::string_view WORKER_THREAD    { "AIEdgeWorker" };         //!< The name of the router service.
    constexpr std::string_view CONSUMER_NAME    { "AIEdgeWorkerConsumer" }; //!< The name of the router service consumer.
